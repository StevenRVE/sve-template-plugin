...
*/
void Template-plugin::initParameter(uint32_t index, Parameter& parameter)
{
...
*/
float Template-plugin::getParameterValue(uint32_t index) const
{
    switch (index)
    {
        // MASTER PARAMS
...
*/
void Template-plugin::setParameterValue(uint32_t index, float value)
{
    switch (index)
    {
    // MASTER PARAMS
...
void Template-plugin::activate()
{
    // plugin is activated
}

void Template-plugin::deactivate()
{
...
*/
void Template-plugin::run(const float**, float**, uint32_t nframes)
{
    // run
}
...
*/
void Template-plugin::sampleRateChanged(double newSampleRate)
{
    (void)newSampleRate;
}
